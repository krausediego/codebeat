...
export function CardRepositoryContent({ data }: CardRepositoryContentProps) {
  ...
  return (
    <div className="flex flex-col bg-card p-6 transition-colors hover:bg-card/60">
      <div className="space-y-8">
        ...
        <div className="mt-3 space-y-2">
          ...
          <p className="line-clamp-2 text-xs text-muted-foreground uppercase">
      ...
      <div className="mt-auto flex items-center justify-between pt-4">
        ...
        <p className="text-sm text-muted-foreground">{pushedAgo}</p>
      </div>
